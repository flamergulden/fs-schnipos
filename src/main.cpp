...
uint256 hashGenesisBlock("0xdb60ea638f79309536b9b8b8b4c3486f56b7835b04bed14d9bffa16dc54fcc37");
...
const string strMessageMagic = "FSSchnipo Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // FSSchnipo: 1 days
static const int64 nTargetSpacing = 120; // FSSchnipo: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal fsschnipo miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "FSSchnipo", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xdb60ea638f79309536b9b8b8b4c3486f56b7835b04bed14d9bffa16dc54fcc37");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "1449516639";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1449516639; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 802317;

        if (fTestNet)
        {
            block.nTime    = 1449516639;
            block.nNonce   = 802317;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x7a7168d37051b21f6df46d613bff6870fc8fd6033cdd52deb82d89a6418806fc"));
